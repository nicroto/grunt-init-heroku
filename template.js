...
exports.description = 'Scaffold Node.JS server app, including Express, Mocha tests and JSHint for deployment on Heroku.';
...
exports.template = function(grunt, init, done) {
	...
	init.process({type: 'node'}, [
		...
		init.writePackageJSON('/source/package.json', props);
